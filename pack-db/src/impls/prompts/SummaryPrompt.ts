export const SUMMARY_PROMPT_TEMPLATE = `Below is a conversation log between a user and an agent. Condense or summarize the conversation log to fit within {targetChars} characters while preserving important context and details.
